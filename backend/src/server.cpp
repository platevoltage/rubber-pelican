...
void interpretDuckyScript(void *parameter) {
  ...
  DuckyCallbacks callbacks = {keyboardCallback, keyboardKeyPressCallback, keyboardShortcutCallback, delayCallback, ledCallback, buttonCallback, enableHIDCallback, enableFlashCallback, disableUSBCallback}; //contains our callbacks
